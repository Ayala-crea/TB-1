  ...
  <!-- <a href="#about">About</a> -->
        ...
        <ul>
            <li>
                ...
                <input type="text" name="username" id="username" required value="<?= $users["username"]; ?>">
            </li>
            <li>
                <label for="waktu_peminjaman">Waktu :</label>
                <input type="text" name="waktu_peminjaman" id="waktu_peminjaman" value="<?= $users["waktu_peminjaman"];?>">
            </li>
            <li>
                <label for="playstasion">playstasion :</label>
                <input type="text" name="playstasion" id="playstasion" value="<?= $users["playstasion"];?>">
            </li>
            <li>
